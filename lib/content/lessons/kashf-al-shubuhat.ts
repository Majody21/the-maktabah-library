...
const FAWZAN_PDF =
  "https://drive.google.com/file/d/1IKZCenUO1K8zz0mhOlfdrJyydUfJXF_3/view";

export const kashfAlShubuhatLessons: Lesson[] = [
  {
    ...
    proofs: [
      {
        ...
        lessonId: "kashf-al-shubuhat--two-tawheeds",
        type: "quran",
        displayOrder: 1,
        arabicText:
        ...
        englishTranslation:
          "And if you asked them who created the heavens and the earth, they would surely say, 'Allah.' Say: all praise is due to Allah. But most of them do not know.",
        reference: "Surah Luqman 31:25",
      },
      {
        id: "kashf-al-shubuhat--two-tawheeds--p2",
        lessonId: "kashf-al-shubuhat--two-tawheeds",
        type: "quran",
        displayOrder: 2,
        arabicText:
    ...
    proofs: [
      {
        ...
        lessonId: "kashf-al-shubuhat--intercession",
        type: "quran",
        displayOrder: 1,
        arabicText:
      ...
      {
        id: "kashf-al-shubuhat--intercession--p2",
        lessonId: "kashf-al-shubuhat--intercession",
        type: "quran",
        displayOrder: 2,
        arabicText:
        ...
        englishTranslation:
          "Say: to Allah belongs [the right to allow] all intercession. To Him belongs the dominion of the heavens and the earth.",
        reference: "Surah az-Zumar 39:44",
      },
      {
        id: "kashf-al-shubuhat--intercession--p3",
        lessonId: "kashf-al-shubuhat--intercession",
        type: "quran",
        displayOrder: 3,
        arabicText:
        ...
        englishTranslation:
          "Those whom they invoke are themselves seeking the means of nearness to their Lord — which of them is nearest — and hoping for His mercy and fearing His punishment.",
