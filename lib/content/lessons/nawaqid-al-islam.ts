...
export const nawaqidAlIslamLessons: Lesson[] = [
  {
    ...
    videoYoutubeUrl: "https://www.youtube.com/watch?v=ZVyt3iufvbc&list=PLcNmEBnwyvx5osgWR-7AsrHoh0X9ffGC6",
    videoScholar: "Ustadh Abu Hakeem Bilal Davis",
    videoTitle: "The Nullifiers of Islam (lesson series)",
    bookRecommendations: [
      {
