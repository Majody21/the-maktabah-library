...
/** Horizontal shift of the furniture, to keep it clear of the reading column. */
const FURNITURE_X = 300;
  ...
  return (
    <div className="library-scene" aria-hidden="true">
      ...
      >
        ...
        {/* furniture, shifted clear of the reading column */}
        <g transform={`translate(${FURNITURE_X} 0)`}>
          {/* rug */}
          ...
          {/* ink pen resting on the table beside the book */}
          <g transform="rotate(-6 785 631)">
            <rect x="750" y="628.5" width="56" height="5" rx="2.5" fill="#2e2013" />
            <rect x="799" y="628.5" width="7" height="5" fill="#8a6a2a" />
            <path d="M806 629 L820 631 L806 633 Z" fill="#c9a24a" />
            <path d="M812 630.6 L818 631 L812 631.5 Z" fill="#6b5220" />
            <circle cx="751" cy="631" r="2.9" fill="#4a3520" />
          </g>

          {/* open book, spine pressed down so it lies flat on the table */}
          <g>
            <path d="M830 624 L876 628 L876 637 L832 634 Z" fill="#d9caa9" opacity="0.94" />
            <path d="M876 628 L922 624 L920 634 L876 637 Z" fill="#cfbf9d" opacity="0.94" />
            <path d="M876 628 L876 637" stroke="#9c8a68" strokeWidth="1.4" opacity="0.7" />
            {/* text lines, following the tilt of each page */}
            <path d="M837 626.5 L871 629.5 M838 629.5 L871 632.5 M839 632.5 L868 635" stroke="#9c8a68" strokeWidth="0.9" opacity="0.55" />
            <path d="M881 629.5 L915 626.5 M881 632.5 L914 629.5 M884 635 L911 632.5" stroke="#9c8a68" strokeWidth="0.9" opacity="0.55" />
          </g>
